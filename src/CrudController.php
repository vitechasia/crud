...
class CrudController extends Controller
{
    public function insert(Request $request){
        ...
        $model = [
            ...
            '{{modelNameSpace}}' => config('crud.namespace.model'),
        ...
        $pathslist = [
            [
                'target'=>str_replace('\\','/',config('crud.path.model')),
                'source'=>str_replace('\\','/',config('crud.path.stub')),
                'new'   =>ucwords($request->modelName).'.php',
                'stub'  =>$stubmodelfile
            ],[
                'target'=>str_replace('\\','/',config('crud.path.migration')),
                'source'=>str_replace('\\','/',config('crud.path.stub')),
                ...
                'target'=>str_replace('\\','/',config('crud.path.controller').'Admin/'),
                'source'=>str_replace('\\','/',config('crud.path.stub')),
                ...
                'view' => [
                    [
                        'target'=>str_replace('\\','/',config('crud.path.views').'modul/').strtolower($request->modelName).'/',
                        'source'=>str_replace('\\','/',config('crud.path.stub')),
                        'stub'=>'create.stub',
